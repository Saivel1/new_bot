...
from keyboards.builder import PayMenu, SubMenu
...
async def call_start(callback: CallbackQuery):
    await callback.message.edit_text(f"Привет! Твой ID: {message.from_user.id}", reply_markup=MainKeyboard.main_keyboard()) # type: ignore
